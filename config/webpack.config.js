...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
            ...
            chunks: ['main', 'runtime', 'vendors', 'mui', 'common'],
            filename: 'index.html',
          },
          isEnvProduction
            ? {
      ...
      // 工具页面的 HTML 插件
      ...Object.keys(paths.toolEntries).map(tool => 
        new HtmlWebpackPlugin({
          inject: true,
          template: paths.toolHtmlTemplate,
          filename: `tools/${tool}/index.html`,
          chunks: [tool, 'runtime', 'vendors', 'mui', 'common'],
          ...(isEnvProduction && {
            minify: {
              removeComments: true,
              collapseWhitespace: true,
